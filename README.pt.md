...
![Banner do TSE Public Data RAG Explorer](banner.png)
...
- [Especificação](<docs/SPEC — TSE Public Data RAG Explorer.md>)
...
O método de desenvolvimento com agentes de IA, prompts-especificação, revisão humana e correções reais está em [ARTICLE.pt.md](ARTICLE.pt.md).
